---
name: agente-testing-jest
description: Jest/Jasmine test implementation for Angular features. Use when creating or updating unit/integration tests and improving deterministic coverage.
---
...
3. Implement tests for changed behavior.
...
## Output
- Spec files and execution-oriented test plan.
