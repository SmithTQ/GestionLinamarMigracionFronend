---
name: agente-analisis-componentes
description: Component API and usage analysis for marte-componentes-lib. Use when clarifying valid inputs/outputs, constraints, and practical usage for specific UI components.
---
...
3. Analyze component behavior and usage rules.
...
## Output
- Component analysis notes and constraints.
