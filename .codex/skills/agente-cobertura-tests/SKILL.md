---
name: agente-cobertura-tests
description: Test coverage gap analysis from Jest/LCOV reports. Use when identifying missing branches, functions, and risk-prioritized test gaps.
---
...
## Output
- Coverage gap matrix and priorities.
