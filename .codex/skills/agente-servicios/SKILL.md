...
description: Service-layer design for ApiService, State/Facade, Mapper, and validation services. Use when defining backend integration and state boundaries.
---
...
3. Design service architecture per feature.
...
## Output
- Service design blueprint and contracts.
